    ...
    Select Case ActionKey
        ...
        Case "GO_TO_TODAY"
            ...
            Select Case PrimaryLanguageID
                Case LANG_FRENCH
                    DP_GetDatePickerActionText = "Aujourd'hui"
                Case LANG_GERMAN
                    DP_GetDatePickerActionText = "Heute"
                Case LANG_SPANISH
                    DP_GetDatePickerActionText = "Hoy"
                Case LANG_ITALIAN
                    DP_GetDatePickerActionText = "Oggi"
                Case LANG_JAPANESE
                    DP_GetDatePickerActionText = _
        ...
        Case "GO_TO_CURRENT_MONTH"
            ...
            Select Case PrimaryLanguageID
                Case LANG_FRENCH
                    DP_GetDatePickerActionText = "Ce mois"
                Case LANG_GERMAN
                    DP_GetDatePickerActionText = "Dieser Monat"
                Case LANG_SPANISH
                    DP_GetDatePickerActionText = "Este mes"
                Case LANG_ITALIAN
                    DP_GetDatePickerActionText = "Questo mese"
                Case LANG_JAPANESE
                    DP_GetDatePickerActionText = _
            ...
            Select Case PrimaryLanguageID
                ...
                Case LANG_VIETNAMESE
                    DP_GetDatePickerActionText = _
                        ...
                        ChrW(&H6E) & ChrW(&H61) & ChrW(&H79)
                Case Else
                    DP_GetDatePickerActionText = "This Year"
            End Select
